/*
redis连接池 go-redis	2020-05-27
https://www.shuzhiduo.com/A/QW5Y6DqMdm/
*/
...
func main() {
	gClient = redis.NewClient(&redis.Options{
		...
		Addr:     "192.168.8.123:6379", //主机名+冒号+端口，默认localhost:6379
		Password: "8888",               //密码
		DB:       10,                   // redis数据库index
		//连接池容量及闲置连接数量
		...
		Dialer: func() (net.Conn, error) {
			...
			return netDialer.Dial("tcp", "192.168.8.123:6379")
		},
		//钩子函数
